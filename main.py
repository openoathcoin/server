...
if __name__ == "__main__":
  ...
  tp.run(gui, title=title, favicon=logo_file, watermark="")  # listening at localhost:5000 by default
else:
  # for production
  # run source env/bin/activate to activate virtual environment
  ...
  app = tp.run(gui, title=title, favicon=logo_file, watermark="", run_server=False)
